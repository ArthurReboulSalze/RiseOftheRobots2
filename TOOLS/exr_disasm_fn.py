# Exporte le listing assembleur des fonctions de RISE2_EXR -> ANALYSIS/funcs/asm_fn_<addr>.txt
...
for a in ADDRS:
    ...
    print("asm_fn_%x.txt (%d octets)" % (fn.getEntryPoint().getOffset(), fn.getBody().getNumAddresses()))
project.close()